...
var param1Value = queryParams.get("param1");
var param2Value = queryParams.get("param2");
...
function closeChat() {
  ...
  function getResponse(qry) {
    const url =
      `https://api.jugalbandi.ai/query-with-langchain-gpt4?uuid_number=f9cd9892-1bf7-11ee-aada-65a812796123&query_string=${qry}`;
    const headers = {
...
function sendMessage() {
 ...
 getResponse(userInput).then((res)=> 
    {
      hideLoadingDots();
      displayMessage(res.answer, "bot");
    })
}
